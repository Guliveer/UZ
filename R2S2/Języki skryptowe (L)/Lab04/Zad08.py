# Zmienić zakres zmiennych z zad 7. na zmienne chronione i dodać funkcje pozwalające na
# wyświetlanie wersji oraz autora pakietu
...
def __main__():
    ...
    print(f"Autor pakietu: {get_author()}")
    print(f"Wersja pakietu: {get_version()}")
