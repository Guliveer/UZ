...
/**
 * Klasa implementująca operację odejmowania dla kalkulatora.
 * Implementuje interfejs Runnable, aby mogła być użyta jako akcja w OpcjaMenu.
 * 
 * Pobiera dwie liczby od użytkownika i wyświetla wynik ich różnicy.
 */
public class OperacjaOdejmowanie implements Runnable {
    
    /** Scanner do odczytu danych wejściowych od użytkownika */
    private Scanner scanner;
    
    /**
     * Konstruktor tworzący operację odejmowania.
     * 
     * @param scanner Scanner do odczytu liczb od użytkownika
     */
    public OperacjaOdejmowanie(Scanner scanner) {
